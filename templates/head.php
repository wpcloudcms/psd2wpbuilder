...
// Get the button that opens the modal
    var btn = document.getElementById("btnpricing1");
    var btn = document.getElementById("btnpricing2");
    var btn = document.getElementById("btnpricing3");
    var btn = document.getElementById("btnpricing4");
    var btn = document.getElementById("btnpricing5");
    var btn = document.getElementById("btnpricing6");
