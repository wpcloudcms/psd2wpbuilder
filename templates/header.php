...
<?php global $bigcloudcms_premium; if(isset($bigcloudcms_premium['logo_layout'])) {
            ...
            else if($bigcloudcms_premium['logo_layout'] == 'logowidget') {$logocclass = 'col-md-4'; $menulclass = 'col-md-12';}
  ...
  <section id="cat_nav" class="navclass">
    ...
    <?php endif; ?> 
     ...
     <?php if(isset($bigcloudcms_premium['slider_abovebelow_widget']) && $bigcloudcms_premium['slider_abovebelow_widget'] == 'sliderabovewidget') { ?>
              <div class="aboveheader col-md-12"> <?php 
                if(is_active_sidebar('slider-above-widget')) { dynamic_sidebar('slider-above-widget'); } ?>
              </div>
               <?php } ?>
      <?php if(isset($bigcloudcms_premium['slider_abovebelow_widget']) && $bigcloudcms_premium['slider_abovebelow_widget'] == 'sliderbothwidgets') { ?>
              <div class="aboveheader col-md-12"> <?php 
                if(is_active_sidebar('slider-above-widget')) { dynamic_sidebar('slider-above-widget'); } ?>
              </div>
               <?php } ?>
...
<?php } else { ?>
 <div class="container">
<?php } ?>
       <?php if(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slider_widget_layout'] == 'slideronly') { ?>
    <div class="col-md-12">
        <?php } elseif(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slidernwidget_cols'] == 'col-md-10') { ?> 
        <div class="slider-left col-md-10">
        <?php } elseif(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slidernwidget_cols'] == 'col-md-9') { ?> 
        <div class="slider-left col-md-9">
            <?php } elseif(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slidernwidget_cols'] == 'col-md-8') { ?> 
        <div class="slider-left col-md-8">
            <?php } elseif(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slidernwidget_cols'] == 'col-md-7') { ?> 
        <div class="slider-left col-md-7">
            <?php } elseif(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slidernwidget_cols'] == 'col-md-6') { ?> 
     ...
     <?php if(isset($bigcloudcms_premium['slider_widget_layout']) && $bigcloudcms_premium['slidernwidget_cols'] == 'col-md-10') { ?> 
     ...
     <?php if(isset($bigcloudcms_premium['slider_abovebelow_widget']) && $bigcloudcms_premium['slider_abovebelow_widget'] == 'sliderbelowwidget') { ?>
