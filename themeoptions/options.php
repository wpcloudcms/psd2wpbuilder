...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id'=>'min_width_1200px',
            'type' => 'textarea',
            'title' => __('(col-lg) (Above 1200px)', 'virtue'), 
            'subtitle' => __('@media (min-width:1200px)', 'virtue'),
            //'validate' => 'css',
        ...
        array(
            ...
            'type' => 'textarea',
            'title' => __('(col-md) (Between 992px to 1199px)', 'virtue'), 
            'subtitle' => __('@media (min-width:992px) and (max-width:1199px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-lg-md-above-992px-1200px'),
            ),
        array(
            'id'=>'min_width_992px',
            'type' => 'textarea',
            'title' => __('(col-md) (Above 992px)', 'virtue'), 
            'subtitle' => __('@media (min-width:992px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-lg-md-above-992px-1200px'),
            ),
        ...
        array(
            ...
            'subtitle' => __('@media (max-width:991px) and (min-width:768px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-md-sm-above-768px-991px'),
            ),
        array(
        ...
        array(
            ...
            'subtitle' => __('@media (max-width:767px) and (min-width:480px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-sm-xs-below-767px-479px'),
            ),
        array(
            'id'=>'max_width_479px',
            'type' => 'textarea',
            'title' => __('(col-xs) (Below 479px)', 'virtue'), 
            'subtitle' => __('@media (max-device-width: 480px) and (orientation: landscape)', 'virtue'),
            'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-sm-xs-below-767px-479px'),
            ),
             array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array( 
                 array(
                    ...
                    'subtitle' => __('<a href="http://www.w3schools.com/css/css_background.asp">http://www.w3schools.com/css/css_background.asp</a>', 'virtue'),
                    //'validate' => 'js',
