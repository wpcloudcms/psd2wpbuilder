...
//        ".__('For support please visit', 'virtue').": <a href=\"http://kadencethemes.com/support/\" target=\"_blank\">kadencethemes.com/support/</a></p></div>",
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'slider', 
            'title' => __('Left Sidebar width %', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "25",
            "min"       => "0",
            "step"      => ".5",
        ...
        array(
            ...
            'type' => 'slider', 
            'title' => __('Right Sidebar width %', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "33",
            "min"       => "0",
            "step"      => ".5",
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
           array(
            'id'=>'footersection_width',
            'type' => 'select',
            'title' => __('Footer Width Boxed or Full', 'bigcloudcms'), 
            'options' => array('boxed' => 'Boxed','full' => 'Full'),
            'default' => 'boxed',
            'width' => 'width:35%', 
            ), 
      ...
      array(
            ...
            array(
            'id'=>'info_copyrights_background',
            'type' => 'info',
            'customizer' => true,
            'desc' => __('Copyrights Background', 'virtue'),
            ),
    array(
...
Redux::setSection( $opt_name, array(
    ...
    'desc' => "<div class='redux-info-field'><h3>".__('Primary Menu Options (Near Logo)', 'virtue')."</h3></div>",
    'fields' => array(
        array(
            'id'=>'menu_search',
            'customizer' => true,
    ...
    'fields' => array(
        ...
        array(
            ...
            'options' => array(
                               ...
                               'max_width_1199px_min_width_1200px'    => '@media (max-width: 1199px) and @media (min-width: 1200px)',
                              ),
            'default' => 'max_width_991px_min_width_992px',
            'width' => 'width:80%', 
            ),
        array(
            'id'=>'max_width_991px',
...
//            ),
        ...
        array(
            ...
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max_width_767px_min_width_768px'),
            ),
        array(
            'id'=>'min_width_768px',
            'type' => 'textarea',
