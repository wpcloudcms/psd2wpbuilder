    ...
    'fields' => array(
        ...
        array(
            ...
            'options' => array('col-lg-md-above-992px-1200px'            => '(col-lg) (Above 1200px)',
                               ...
                               'max-width-767px'                        => '(col-xs)(Below 767px)',
            ...
            'subtitle' => __('Quickly add some Bootstrap CSS to min-width-1200px.', 'virtue'),
            //'validate' => 'css',
        ...
        array(
            ...
            'subtitle' => __('Quickly add some Bootstrap CSS to min-width-992px-and-max-width-1199px.', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-lg-md-above-992px-1200px'),
            ),
        array(
            ...
            'subtitle' => __('Quickly add some Bootstrap CSS to min-width-992px.', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-lg-md-above-992px-1200px'),
            ),
             array(
