    ...
    'fields' => array(
        ...
        array(
            ...
            'options' => array('col-lg-md-above-992px-1200px'            => 'col-lg-md-above-992px-1200px',
                               ...
                               'col-sm-xs-below-767px-480px'             => 'col-sm-xs-below-767px-480px',
        ...
        array(
            'id'=>'max_width_480px',
            'type' => 'textarea',
            'title' => __('(col-xs) (Below 480px)', 'virtue'), 
            'subtitle' => __('Quickly add some Bootstrap CSS to max_width_480px.', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','col-sm-xs-below-767px-480px'),
            ),
             array(
