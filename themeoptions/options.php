...
//        ".__('For support please visit', 'virtue').": <a href=\"http://kadencethemes.com/support/\" target=\"_blank\">kadencethemes.com/support/</a></p></div>",
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'slider', 
            'title' => __('For Small Screen Size', 'virtue'),
        ...
        array(
            'id'=>'site_top_margin',
            'type' => 'slider', 
            'title' => __('Site Top Margin Space', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "0",
            "min"       => "0",
            "step"      => "5",
        ...
        array(
            ...
            'type' => 'slider', 
            'title' => __('Content Top Margin Space', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "0",
            "min"       => "0",
            "step"      => "5",
        ...
        array(
            'id'=>'site_logo_width',
            'type' => 'slider', 
            'title' => __('Site Logo Width', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "400",
            "min"       => "50",
            "step"      => "5",
...
array(
            ...
            'type' => 'color',
            'title' => __('Copyrights Background Color', 'virtue'), 
            'default' => '',
            'customizer' => true,
            'validate' => 'color',
            ),
    ...
    'fields' => array(
       ...
       array(
        ...
        array(
            'id'=>'page_title',
            'type' => 'switch', 
            'title' => __('Show All Pages Title?', 'virtue'),
            'subtitle'=> __('OFF to hide all pages Title', 'virtue'),
            "default"       => 1,
            ),
       array(
            "id" => "homepage_layout",
...
Redux::setSection( $opt_name, array(
    ...
    array(
            ...
            'type' => 'info',
            'customizer' => true,
            'desc' => __('Primary Menu Background', 'virtue'),
            ),
      array(
            'id'=>'pmenu_bg_color',
            'type' => 'color',
            'title' => __('Primary Menu Background Color', 'virtue'), 
            'default' => '',
            'customizer' => true,
            'validate' => 'color',
            ),
...
Redux::setSection( $opt_name, array(
    ...
    array(
            ...
            'type' => 'slider', 
            'title' => __('Primary Menu Item Height', 'virtue'),
    ...
    array(
        ...
        array(
            ...
            'type' => 'slider', 
            'title' => __('Primary menu separator width', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "1",
            "min"       => "0",
            "step"      => "1",
        ...
        array(
            ...
            'type' => 'slider', 
            'title' => __('Separator position', 'virtue'),
            'subtitle' => __('', 'virtue'),
            "default"       => "0",
            "min"       => "-50",
            "step"      => "1",
        ...
        array(
            ...
            'type' => 'color',
            'title' => __('Primary menu separator Color', 'virtue'), 
            'default' => '',
            'transparent'=>false,
            'customizer' => true,
            'validate' => 'color',
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'id'=>'info_CSS',
            'type' => 'info',
            'desc' => __('Bootstrap Custom css', 'virtue'),
            ),
        array(
            'id'=>'bootstrap_custom_css',
            'type' => 'select',
            'title' => __('Choose your Bootstrap Custom css', 'virtue'), 
            'options' => array('max-width-400px-min-width-401px'      => '@media (max-width: 400px) and @media (min-width: 401px)',
                               'max-width-543px-min-width-544px'      => '@media (max-width: 543px) and @media (min-width: 544px)',
                               'max-width-767px-min-width-768px'      => '@media (max-width: 767px) and @media (min-width: 768px)',                               
                               'max-width-991px-min-width-992px'      => '@media (max-width: 991px) and @media (min-width: 992px)',
                               'max-width-1199px-min-width-1200px'    => '@media (max-width: 1199px) and @media (min-width: 1200px)',
                              ),
            'default' => 'max-width-991px-min-width-992px',
            'width' => 'width:80%', 
            ),
        array(
            'id'=>'max-width-991px',
            'type' => 'textarea',
            'title' => __('(col-md) (Below 992px)', 'virtue'), 
            'subtitle' => __('@media (max-width:991px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-991px-min-width-992px'),
            ),
        array(
            'id'=>'min-width-992px',
            'type' => 'textarea',
            'title' => __('(col-lg) (Above 991px)', 'virtue'), 
            'subtitle' => __('@media (min-width:992px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-991px-min-width-992px'),
            ),
        ...
        array(
            ...
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-400px-min-width-401px'),
            ),
        array(
            'id'=>'min-width-401px',
            'type' => 'textarea',
        ...
        array(
            'id'=>'max-width-543px',
            'type' => 'textarea',
            'title' => __('(col-xs) (Below 544px)', 'virtue'), 
            'subtitle' => __('@media (max-width:543px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-543px-min-width-544px'),
            ),
        array(
            'id'=>'min-width-544px',
            'type' => 'textarea',
        ...
        array(
            'id'=>'max-width-767px',
            'type' => 'textarea',
            'title' => __('(col-sm) (Below 768px)', 'virtue'), 
            'subtitle' => __('@media (max-width:767px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-767px-min-width-768px'),
            ),
        array(
            'id'=>'min-width-768px',
            'type' => 'textarea',
            'title' => __('(col-md) (Above 767px)', 'virtue'), 
            'subtitle' => __('@media (min-width:768px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-767px-min-width-768px'),
            ),
        ...
        array(
            'id'=>'max-width-1199px',
            'type' => 'textarea',
            'title' => __('(col-lg) (Below 1200px)', 'virtue'), 
            'subtitle' => __('@media (max-width:1199px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-1199px-min-width-1200px'),
            ),
        array(
            'id'=>'min-width-1200px',
            'type' => 'textarea',
            'title' => __('(col-xl) (Above 1199px)', 'virtue'), 
            'subtitle' => __('@media (min-width:1200px)', 'virtue'),
            //'validate' => 'css',
            'required' => array('bootstrap_custom_css','=','max-width-1199px-min-width-1200px'),
            ),
