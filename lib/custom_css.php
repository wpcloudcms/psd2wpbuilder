...
if(!empty($virtue_premium['pmenu_bg_color']) || !empty($virtue_premium['bg_pmenu_bg_img']['url'])) {
    $pmenuclass_ext = 'nav#nav-main {background:'.$pmenu_bg_color.' '.$pmenu_bg_img.' '.$pmenu_bg_repeat.' '.$pmenu_bg_x.' '.$pmenu_bg_y.';}';
  } else {
    $pmenuclass_ext = '';
  }
