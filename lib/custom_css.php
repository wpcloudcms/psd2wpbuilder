...
if(isset($virtue_premium['secondary_menu_width'])) {
  $smenu_padding = '#nav-second ul.sf-menu>li>a {padding-left:'.$virtue_premium['secondary_menu_width'].'px; padding-right:'.$virtue_premium['secondary_menu_width'].'px; width: auto;}';
  } else {
  $smenu_padding = '';
  } 
if(isset($virtue_premium['secondary_menu_height'])) {
  $smenu_height = '#nav-second ul.sf-menu>li>a {line-height:'.$virtue_premium['secondary_menu_height'].'px;';
  } else {
  $smenu_height = '';
  } 
