...
if (!empty($virtue_premium['min_width_1200px_css'])) {
  $min_width_1200px_css = $virtue_premium['min_width_1200px_css'];
} else {
  $min_width_1200px_css = '';
}    
