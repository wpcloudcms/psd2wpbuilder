...
if(isset($virtue_premium['menu_margin_top'])) {
 $menu_margin_top = '#nav-main, .nav-main {top:'.$virtue_premium['menu_margin_top'].'px;}';
 } else {
  $menu_margin_top = '#nav-main, .nav-main {top:30px;}';
 } 
 if(isset($virtue_premium['menu_margin_left'])) {
 $menu_margin_left = '#nav-main, .nav-main  {left:'.$virtue_premium['menu_margin_left'].'px;}';
} else {
  $menu_margin_left = '#nav-main, .nav-main {left:10px;}';
}
//Typography
...
if(isset($virtue_premium['second_menu_sep']) and $virtue_premium['second_menu_sep'] == 'yes') {
  $second_menu_sep = '#nav-second ul li:after {width:'.$virtue_premium['second_sep_width'].'px;left:-'.$virtue_premium['second_sep_width'].'px; background-color:'.$virtue_premium['second_sep_color'].';}';
  } else {
  $second_menu_sep = '';
  } 
if(isset($virtue_premium['third_menu_width'])) {
  $tmenu_padding = '#nav-third ul.sf-menu>li, #nav-third ul.sf-menu>li>a {padding-left:'.$virtue_premium['third_menu_width'].'px; padding-right:'.$virtue_premium['third_menu_width'].'px; width: auto;}';
  } else {
  $tmenu_padding = '';
  } 
...
if(isset($virtue_premium['third_menu_sep']) and $virtue_premium['third_menu_sep'] == 'yes') {
  $third_menu_sep = '#nav-third ul li:after {width:'.$virtue_premium['third_sep_width'].'px;left:-'.$virtue_premium['third_sep_width'].'px; background-color:'.$virtue_premium['third_sep_color'].';}';
  } else {
  $third_menu_sep = '';
  }
