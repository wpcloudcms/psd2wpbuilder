...
if(!empty($virtue_premium['fontfamily_copyrt_text'])) {
  $fontfamily_copyrt_text = '.credit p, .credit span, .credit a, .credit span a {font-family:'.$virtue_premium['fontfamily_copyrt_text'].';}';
} else {
